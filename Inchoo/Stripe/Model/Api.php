...
class Api extends \Magento\Payment\Model\Method\AbstractMethod{
	...
	public function __construct(\Magento\Customer\Model\Session $customerSession,\Magento\Store\Model\StoreManagerInterface $storeManager, \Magento\Directory\Model\Currency $currency){
        ...
        $this->helper = $objectManager->get('Inchoo\Stripe\Helper\Data');
	...
	public function apiLogin() {
        ...
        $dataForLogin = array(
        				'UserName' => $this->helper->getConfig("payment/inchoo_stripe/api_username"),
		                'Password' => $this->helper->getConfig("payment/inchoo_stripe/api_password"),
    ...
    public function createDataForInstallmentPlanInit($selectedInstallment){
    	...
    	$params = [
            "RequestHeader" => [
                ...
                "ApiKey"    => $this->helper->getConfig("payment/inchoo_stripe/api_terminal_key"),
            ],
            "PlanData"      => [
                "Amount"    => [
    ...
    public function getApiUrl() {
    	...
    	$helper = $this->helper;
        if($helper->getConfig("payment/inchoo_stripe/sandbox_flag")){
        	return $helper->getConfig("payment/inchoo_stripe/api_url_sandbox");
        }
        return $helper->getConfig("payment/inchoo_stripe/api_url");
    ...
    public function getFirstInstallmentAmount($selectedInstallment){
    	...
    	$firstPayment = $this->helper->getConfig('payment/inchoo_stripe/first_payment');
        $percentageOfOrder = $this->helper->getConfig('payment/inchoo_stripe/percentage_of_order');
